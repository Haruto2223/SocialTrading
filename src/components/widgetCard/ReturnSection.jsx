const ReturnSection = () => {
    return (
        <div className="bg-slate-100 p-20 flex lg:flex-row md:flex-col md:justify-center space-x-14">
            <div className="bg-white p-10 text-3xl flex-1 max-w-[20%] break-words lg:flex-1 rounded-md">
